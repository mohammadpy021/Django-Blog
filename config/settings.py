...
SECRET_KEY="(k%6+myl==3*xnd5c_+(_@$^ng@*d!hdohf&0n4+)a6$=y*l9r"
...
INSTALLED_APPS = [
    'django.contrib.admin', #comment this in case Error for first Creating superuser
    'django.contrib.auth',
...
MIDDLEWARE = [
    ...
    # 'blog.middleware.SaveIPAddressMiddleware', #custom
]
